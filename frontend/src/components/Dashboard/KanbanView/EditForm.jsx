import classes from "../../profile/components/EditForm.module.css"
...
export default function EditForm({task, setEditChange}){
...
const [users, setUsers]= useState([])
 ...
 let id = task._id;
  ...
  async function fetchUsers(){
      try{
        const userData =await fetchListOfUsers(token);
        setUsers(userData);
      }catch(error){
  ...
  console.log("HandleEdit Form triggered by handleEditFunction: ")
  console.log("Users in EditForm that comes from backend: ", users);
      ...
      try{
       const data = await updateTask(task, token, id);
 ...
 console.log("Handle submit Triggered to submit kanban EditForm:");
      setLoading(false)
      setEditChange(false);
    }
